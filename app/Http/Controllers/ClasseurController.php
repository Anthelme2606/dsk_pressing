...
class ClasseurController extends Controller
{
    ...
    public function index()
    {
        if (Auth::user()->getRoleNames()->contains("manager")){
            $users = User::where("agency_id", Auth::user()->agency_id)->role("classeur")->get();
        }else {
            $users = User::role("classeur")->get();
        }
         // Liste des caissiers ayant un role caissier


         return view('classeurs.index')->with('users', $users);
    }
    ...
    public function store(Request $request)
    {
        ...
        $user->assignRole('classeur');
        $user->save();

        //Redirect to the users.index view and display message
        return redirect()->route('classeurs.index')
            ->with('success', 'Classeur ajouté avec succès.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('classeurs.edit', compact('user', 'agencies')); //pass user and roles data to view
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('classeurs.index')
               ->with('success', 'Classeur edité avec succès.');
    }
