<?php $__env->startSection('title', '| Ajouter caissier'); ?>
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class='fa fa-user-plus'></i> Ajouter caissier</li>
      </ol>
    </section>
      ...
      <div class='col-md-8 col-md-offset-2'>
            <div class="box box-primary">
                <div class="box-header with-border">
                  <h4 class="box-tite" style="text-align: center;"><b> Ajouter un(e) caissier(ère)</b></h4>
                </div>

                <form action="<?php echo e(route('tellers.store')); ?>" class="form-horizontal form-box remove-margin" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <div class="form-group">
                                    <label for="agency">Agence de travail du caissier <span style="color: red;">*</span></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/tellers/create.blade.php ENDPATH**/ ?>