                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" data-toggle="modal" onclick="treated(<?php echo e($deposit->id); ?>)" data-target="#confirm" class="btn btn-xs btn-success"><i class="fa fa-thumbs-o-up"></i>Valider</a>
...
function treated(id)
     {
         var id = id;
         var url = '<?php echo e(route("make_treated", ":id")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/traitements/list_deposits_in_progress.blade.php ENDPATH**/ ?>