...
<body class="hold-transition green layout-top-nav">
    ...
    <nav class="navbar navbar-static-top" style="background-color: rgb(60, 86, 78);">
      <div class="container">
        <div class="navbar-header">
          <img src="<?php echo e(asset('public/uwebsite/images/z.png')); ?>" height="65px;" alt="">
  ...
  <div class="register-box" style="width: 90%; margin-top: -50px;">
    <div class="register-logo">
      ...
      <div class="register-box-body">
        ...
        <form enctype="multipart/form-data" method="post" action="<?php echo e(route('client.register.store')); ?>" onsubmit="launchRequest()">
          <?php echo csrf_field(); ?>
          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-0">
              <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control" placeholder="Veuillez saisir votre nom complet" style="text-transform: capitalize;" name="fullname" value="<?php echo e(old('fullname')); ?>" required>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                

                <?php if($errors->has('fullname')): ?>
                    <span class="invalid-feedback" role="alert">
                        <strong style="color: red;"><?php echo e($errors->first('fullname')); ?></strong>
                    </span>
                <?php endif; ?>
              </div>
            </div>
            <div class="col-md-6 col-md-offset-0">
              <div class="form-group has-feedback">
                ...
                <input type="phone" name="phone_number" class="form-control" placeholder="Ex: 01 0200 2200" value="<?php echo e(old('phone_number')); ?>" required>
          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-0">
              <div class="form-group has-feedback">
                ...
                <div class="row">
                  <div class="col-md-11">
                    <input type="password" name="password" class="form-control" placeholder="Veuillez définir un mot de passe" id="pwd" onchange="confirm()" value="<?php echo e(old('password')); ?>" required/>
                  </div>
                  <div class="col-md-1">
          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-0">
              <div class="form-group has-feedback">
                ...
                <input type="email" name="email" class="form-control" placeholder="Email" id="email" value="<?php echo e(old('email')); ?>"/>
            ...
            <div class="col-md-6 col-md-offset-0">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" name="address" class="form-control" value="<?php echo e(old('address')); ?>" placeholder="Votre adresse ..."/>
            ...
            <div class="row">
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="date" name="birthday" class="form-control" value="<?php echo e(old('birthday')); ?>" placeholder="Date de naissance*">
                ...
                <div class="form-group has-feedback">
                    ...
                    <?php if($errors->has('waiting_for')): ?>
                        <span class="invalid-feedback" role="alert">
                            <strong><?php echo e($errors->first('waiting_for')); ?></strong>
                        </span>
                    <?php endif; ?>
  ...
  <button class="material-scrolltop bg-olive" type="button"></button>
    ...
    <script src="<?php echo e(asset('public/pbower_components/material-scrolltop-master/src/material-scrolltop.js ')); ?>"></script>
...
<?php /**PATH /home/sparqrqm/public_html/testing/resources/views/auth/client/register.blade.php ENDPATH**/ ?>