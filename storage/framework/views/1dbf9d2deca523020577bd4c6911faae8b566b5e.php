                            ...
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tfoot>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><h4><?php echo e($user->fullname); ?></h4></td>
                                            <td><h4><b><?php echo e($user->receiptToDay()); ?> FCFA</b></h4></td>
                                            <td><h4><b><?php echo e($user->articlesToDay()); ?> articles</b></h4></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/receipts/receipeNewToDay.blade.php ENDPATH**/ ?>