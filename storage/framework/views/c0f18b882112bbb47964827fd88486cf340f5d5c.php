                ...
                <div class="box box-solid">
                    ...
                    <!-- /.box-header -->
                        ...
                        <div class="box-footer no-print">
                          ...
                          <a href="<?php echo e(route('checkcustomer')); ?>" class="btn bg-olive pull-right">Retour</a>
                        </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/stats/response.blade.php ENDPATH**/ ?>