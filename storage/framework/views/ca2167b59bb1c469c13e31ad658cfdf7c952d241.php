<?php $__env->startSection('title', '| Ajouter classeur'); ?>
    ...
    <section class="content">
      ...
      <div class='col-md-8 col-md-offset-2'>
            <div class="box box-primary">
                ...
                <form action="<?php echo e(route('classeurs.store')); ?>" class="form-horizontal form-box remove-margin" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                    <div class="box-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/classeurs/create.blade.php ENDPATH**/ ?>