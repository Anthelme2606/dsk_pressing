<?php $__env->startSection('title', '| Etats opérations journalières'); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    ...
                    <!-- /.box-header -->
                        <div class="box-body">
                            <h5 align="center" class="box-title"><b>Bilan du</b> : <?php echo e($print_date->format('d-m-Y')); ?></h5><br>
                            
                            <h5 align="center"><b>Nombre de ligne(s) :</b> <span><?php echo e($nbre); ?></span></h5><br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/statsDaily/indexDaily.blade.php ENDPATH**/ ?>