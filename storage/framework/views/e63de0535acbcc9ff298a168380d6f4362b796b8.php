<?php $__env->startSection('title', '| Recherche des recettes'); ?>
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class='fa fa-money'></i> Recette</li>
      </ol>
    </section>
  ...
  <section class="content">
    <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Recherche des recettes</h3>
            </div>

            <form role="form" method="POST" action="<?php echo e(route('searchReceipt')); ?>">
            	<?php echo csrf_field(); ?>
	            <div class="box-body">
	              <div class="row">
	                <div class="col-xs-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/receipts/search.blade.php ENDPATH**/ ?>