...
<!-- Content Header (Page header) -->
    ...
    <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Recherche des impayés</h3>
            </div>

            <form role="form" method="POST" action="<?php echo e(route('searchLeftpay')); ?>">
            	<?php echo csrf_field(); ?>
	            <div class="box-body">
	              <div class="row">
	                <div class="col-xs-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/receipts/searchleftpay.blade.php ENDPATH**/ ?>