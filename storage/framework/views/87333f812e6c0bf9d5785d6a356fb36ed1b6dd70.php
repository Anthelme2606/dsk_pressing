...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-cart-arrow-down"></i> Dépôts traités</li>
  </ol>
</section>
        ...
        <form action="" id="deleteForm" method="post">
            ...
            <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Confirmation de classification</h4>
                  </div>
                  <div class="modal-body">
                    ...
                    <p>Confirmez vous que ce dépôt a été classé?</p>
                  </div>
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h5 class="box-title">Liste des dépôts traités</h5>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" data-toggle="modal" onclick="classed(<?php echo e($deposit->id); ?>)" data-target="#confirm" class="btn btn-xs btn-success"><i class="fa fa-thumbs-o-up"></i> Classer</a>
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('deposits.bon', $deposit->id)); ?>" class="btn btn-info btn-xs"><i class="fa fa-file"></i> Bon</a>
                                            </td>
                                        </tr>
...
function classed(id)
     {
         var id = id;
         var url = '<?php echo e(route("make_classed", ":id")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/traitements/list_deposits_treated.blade.php ENDPATH**/ ?>