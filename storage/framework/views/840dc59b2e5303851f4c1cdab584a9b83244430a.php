                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <?php if(auth()->user()->profile_picture == ''): ?>
                                <img src="<?php echo e(asset('/public/storage/profile_images/user.jpg')); ?>" class="user-image" alt="User Image">
                            <?php else: ?>
                                <img src="<?php echo e(url('/public/storage/profile_images/'.auth()->user()->profile_picture)); ?>" class="user-image" alt="User Image">
                            <?php endif; ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <?php if(auth()->user()->profile_picture == ''): ?>
                                    <img src="<?php echo e(asset('/public/storage/profile_images/user.jpg')); ?>" class="img-circle" alt="User Image">
                                <?php else: ?>
                                    <img src="<?php echo e(url('/public/storage/profile_images/'.auth()->user()->profile_picture)); ?>" class="img-circle" alt="User Image">
                                <?php endif; ?>
                    ...
                    <table class="table">
                        ...
                        <?php $__currentLoopData = $depositedarticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul>
                                        <?php $__currentLoopData = str_split($depot->state); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($state == 1): ?>
                                                <li>Déchiré</li>
                                            <?php endif; ?>
                                            <?php if($state == 2): ?>
                        ...
                        <tfooter>
                            <tr>
                                ...
                                <td><?php echo e($deposit->total + $deposit->discount); ?> FCFA</td>
                            </tr>
                            <tr>
                                <td style="border: none;"></td>
                                <td style="border: none;"></td>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($deposit->total - $deposit->advanced); ?> FCFA</td>
                            </tr>
                        </tfooter>
...
<?php /**PATH /home/sparqrqm/public_html/testing/resources/views/deliveries/show.blade.php ENDPATH**/ ?>