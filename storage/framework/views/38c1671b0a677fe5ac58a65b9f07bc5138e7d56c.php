<?php $__env->startSection('title', '| Caissiers'); ?>
                ...
                <div class="box box-solid">
                    ...
                    <!-- /.box-header -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php endif; ?>
                                        <td>
                                        <a href="<?php echo e(route('tellers.edit', $user->id)); ?>" class="btn btn-xs btn-info pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i> Editer</a>
                        ...
                        <div class="box-footer">
                          <a href="<?php echo e(route('tellers.create')); ?>" class="btn bg-olive">Ajouter caissier</a>
                        </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/tellers/index.blade.php ENDPATH**/ ?>