<?php $__env->startSection('title', '| Recherche sur Dépôt par client'); ?>
...
<!-- Content Header (Page header) -->
    ...
    <div class="box box-danger">
            ...
            <form role="form" method="POST" action="<?php echo e(route('searchdeposit')); ?>">
            	<?php echo csrf_field(); ?>
	            <div class="box-body">
	              <div class="row">
...
<?php $__env->startPush('getcustomer'); ?>
...
//                 // $('#toptal_records').text(data.total_data);
//             }
//         })
//     }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/stats/customer.blade.php ENDPATH**/ ?>