<?php $__env->startSection('title', '| Ajouter laveur'); ?>
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h4>
        <i class='fa fa-user-plus'></i> Laveurs
      </h4>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active"><i class='fa fa-user-plus'></i> Ajouter laveur</li>
      </ol>
    </section>
      ...
      <div class='col-md-8 col-md-offset-2'>
            <div class="box box-primary">
                <div class="box-header with-border">
                  <h4 class="box-tite" style="text-align: center;"><b> Ajouter un(e) laveur(se)</b></h4>
                </div>

                <form action="<?php echo e(route('laveurs.store')); ?>" class="form-horizontal form-box remove-margin" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="fullname" name="fullname" class="form-control" required value="<?php echo e(old("fullname")); ?> ">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <div class="form-group">
                                    <label for="agency">Agence de travail du laveur <span style="color: red;">*</span></label>
                            ...
                            <?php else: ?>
                            <input type="hidden" value="<?php echo e(auth()->user()->agency_id); ?>" name="agency_id" />
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/testing/resources/views/laveurs/create.blade.php ENDPATH**/ ?>