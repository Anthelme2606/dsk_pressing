...
<head>
  ...
  <title><?php echo e(config('app2.name', 'PRESSING')); ?> | Client area</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo e(route('clientarea')); ?>" class="logo" style="background-color: rgb(58, 85, 77);">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">É<b>P</b></span>
      <!-- logo for regular state and mobile devices -->
      
      <span class="logo-lg"><span style="font-size: 16px; font-family:Georgia, 'Times New Roman', Times, serif;">ÉLÉGANCE</span> <b>PRESSING</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <?php if(Auth::guard('client')->user()->picture == ''): ?>
                <img src="<?php echo e(asset('public/avatar.jpeg')); ?>" class="user-image" alt="User Image">
              <?php else: ?>
                <img src="<?php echo e(asset('public/storage/profile_images/'.Auth::guard('client')->user()->picture)); ?>" class="user-image" alt="User Image">
              <?php endif; ?>
              <span class="hidden-xs"><?php echo e(Auth::guard('client')->user()->fullname); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <?php else: ?>
                  <img src="<?php echo e(asset('storage/profile_images/'.Auth::guard('client')->user()->picture)); ?>" class="img-circle" alt="User Image">
                <?php endif; ?>

                <p style="text-transform: capitalize;">
                  <?php echo e(Auth::guard('client')->user()->fullname); ?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(route('profil-client')); ?>" class="btn btn-default btn-flat">Profil</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo e(route('client.logout')); ?>" class="btn btn-default btn-flat" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Quitter</a>

                  <form id="logout-form" action="<?php echo e(route('client.logout')); ?>" method="POST" style="display: none;"><?php echo csrf_field(); ?>
                    </form>
                </div>
              </li>
            </ul>
  ...
  <aside class="main-sidebar" style="background-color: rgb(58, 85, 77);">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <?php if(Auth::guard('client')->user()->picture == ''): ?>
            <img src="<?php echo e(asset('public/avatar.jpeg')); ?>" class="img-circle" alt="User Image">
          <?php else: ?>
            <img src="<?php echo e(url('public/storage/profile_images/'.Auth::guard('client')->user()->picture)); ?>" class="img-circle" alt="User Image">
          <?php endif; ?>
        </div>
        <div class="pull-left info">
          <p style="text-transform: capitalize;" class="col-md-offset-1"><?php echo e(Auth::guard('client')->user()->fullname); ?></p>
          <a href="#"><i class="fa fa-circle text-success col-md-offset-1"></i> En ligne</a>
        </div>
      </div>
      <!-- search form -->
      ...
      <?php echo $__env->make('inc.menu2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<!-- material-scrolltopublic/p plugin -->
...
<?php /**PATH /home/sparqrqm/public_html/testing/resources/views/layouts/app2.blade.php ENDPATH**/ ?>