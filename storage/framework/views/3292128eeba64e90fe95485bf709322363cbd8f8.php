...
<head>
  ...
  <title><?php echo e(config('app.name', 'PRESSING')); ?> | Dashboard </title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <?php else: ?>
                <img src="<?php echo e(url('public/storage/profile_images/'.auth()->user()->picture)); ?>" class="user-image" alt="User Image">
              <?php endif; ?>
              <span class="hidden-xs"><?php echo e(auth()->user()->fullname); ?> - <?php echo e(auth()->user()->getRoleNames()->first()); ?></span>
            </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo e(auth()->user()->fullname); ?> - <?php echo e(auth()->user()->getRoleNames()->first()); ?>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo e(route('logout')); ?>" class="btn btn-default btn-flat" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Quitter</a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <?php if(auth()->user()->picture == ''): ?>
            <img src="<?php echo e(asset('avatar.jpeg')); ?>" class="img-circle" alt="User Image">
          <?php else: ?>
            <img src="<?php echo e(url('storage/profile_images/'.auth()->user()->picture)); ?>" class="img-circle" alt="User Image">
          <?php endif; ?>
        </div>
        <div class="pull-left info">
          <p><?php echo e(auth()->user()->fullname); ?> - <?php echo e(auth()->user()->getRoleNames()->first()); ?></p>
          <i><?php echo e(auth()->user()->agency()->name); ?> - <?php echo e(auth()->user()->agency()->pressing()->name); ?></i> <br>
...
<?php /**PATH /home/sparqrqm/public_html/testing/resources/views/layouts/app.blade.php ENDPATH**/ ?>