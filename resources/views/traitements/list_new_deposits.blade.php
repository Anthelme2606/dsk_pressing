                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 10%">{{ $deposit->code }} / {{ $deposit->user()->agency()->name }}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" data-toggle="modal" onclick="startTreatment({{ $deposit->id}})" data-target="#confirm" class="btn btn-xs btn-success"><i class="fa fa-hourglass-start"></i> Démarrer</a>
...
function startTreatment(id)
     {
         var id = id;
         var url = '{{ route("make_in_progress", ":id") }}';
