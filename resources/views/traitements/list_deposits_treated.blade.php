                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @role("classeur")
                                                <a href="javascript:;" data-toggle="modal" onclick="classed({{ $deposit->id}})" data-target="#confirm" class="btn btn-xs btn-success"><i class="fa fa-thumbs-o-up"></i> Classer</a>
                                                @endrole
                                            </td>
                                        </tr>
                                        @endforeach
