...
<!-- Main content -->
    <section class="invoice">
      ...
      <div class="row">
        ...
        <h3 class="text-center" style="margin-top: -15px; margin-bottom: 25px;"><b>RECU N° :</b> PE/{{ $deposit->id }}
        </h3>
        <div class="col-xs-8">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <tbody>
            @foreach ($deposit_units as $depot)
            <tr>
                <td>
                    {{ $depot->article()->name }}
                </td>
            ...
            @endforeach
              ...
              <tfooter>
                  ...
                  <tr>
                    ...
                    <td><b>Relicat:</b></td>
                    @endif
                    <td>{{ abs($deposit->total - $deposit->advanced- $deposit->discount) }} FCFA</td>
                </tr>
                <tr>
                    <td style="border: none;"></td>
                    <td style="border: none;"></td>
                    ...
                    <td>
                        @foreach($transactions as $trans)
                            <li>{{ $trans->amount }} FCFA / {{ $trans->transaction_date }}</li>
                        @endforeach
                    </td>
                </tr>
              </tfooter>
