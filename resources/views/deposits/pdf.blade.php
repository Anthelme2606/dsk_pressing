...
<!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
          Dépôt
          <small>KE/{{ $deposit->deposit_code }}</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i>  PRESSING
      ...
      <div class="row" align="center">
        <div class="col-lg-4">
          ...
          <address>
            <strong></strong><br>
            <h5>PRESSING TEXTILE EXPERT</h5><br>
            <strong> </strong><br>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <p>
            ...
            Certains vêtements très délicats demandent des 
            traitements spéciaux. 
            En cas de dommage aux 
            vêtements l'Etablissement
             paiera au maximum 5 fois le
              tarif du nettoyage de la pièce.
               Nous déclinons toutes responsabilités pour :
                les boutons, les boucles fermeture-éclair ainsi que les vices cachés.  
          </p>
