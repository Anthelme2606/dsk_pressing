...
<!-- Main content -->
    <section class="invoice">
      ...
      <div class="row">
        ...
        <h3 class="text-center" style="margin-top: -15px; margin-bottom: 25px;"><b>RECU N° :</b> {{$deposit->code}}/{{ $deposit->user()->agency()->name }}
        </h3>
        <div class="col-xs-8">
            ...
            @endforeach
              ...
              <tfooter>
                  ...
                  <tr>
                    ...
                    <td><b>Relicat:</b></td>
                    @endif
                    <td>{{ abs($deposit->total - $deposit->advanced) }} FCFA</td>
                </tr>
              </tfooter>
