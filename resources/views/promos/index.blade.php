    ...
    <div class="col-md-12">
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <a href="{{ route('promos.create') }}" class="btn bg-olive pull-right"><i class='fa fa-plus-square'></i>  Ajouter Promo</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="{{ route('promos.edit', $promo->id) }}" class="btn btn-info btn-xs" style="margin-right: 3px;"><i class="fa fa-edit"></i> Editer</a>

                            <a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $promo->id}})"
            ...
            <div class="box-footer clearfix">
              <a href="{{ route('promos.create') }}" class="btn bg-olive"><i class='fa fa-plus-square'></i>  Ajouter Promo</a>
            </div>
        </div>
    </div>
</div>
...
function deleteData(id)
     {
         var id = id;
         var url = '{{ route("promos.destroy", ":id") }}';
