...
<body class="hold-transition green layout-top-nav">
    ...
    <nav class="navbar navbar-static-top" style="background-color: rgb(60, 86, 78);">
      <div class="container">
        <div class="navbar-header">
          <img src="{{ asset('public/website/images/Se.jpeg')}}" height="65px;" alt=""/>
  ...
  <div class="register-box" style="height: 100%">
    ...
    <div class="register-box-body">
      ...
      <form method="POST" action="{{ route('client.login.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
          <div class="col-xs-5" style="margin-top:2%;">
            <div class="checkbox">
              <a href="{{ route('client.register') }}" class="text-center"><b style="color: rgb(40, 96, 74);">S'inscire ?</b></a>
            </div>
          </div>
          <!-- /.col -->
          <div class="col-xs-7">
