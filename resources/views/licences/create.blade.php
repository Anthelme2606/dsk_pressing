...
<head>
  ...
  <title>{{config('app.name', 'PRESSING')}} | Code d'activation</title>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                @else
                  <img src="/storage/cover_images/{{ auth()->user()->profile}}" class="user-image" alt="User Image">
                @endif
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                    ...
                    @else
                      <img src="/storage/cover_images/{{ auth()->user()->profile}}" class="img-circle" alt="User Image">
                    @endif

                    <p>
                      {{ auth()->user()->fullname }} {{--- {{ auth()->user()->user_profession }} --}}
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-md-offset-3">
            <div class="box box-primary">
                ...
                <h4 class="box-tite"><b>{{ __('Code d\'activation') }}</b></h4>
                </div>
                ...
                <div class="box-body">
                    ...
                    <form method="POST" action="{{ route('licences.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="code" class="col-md-4 col-form-label text-md-right">{{ __('Code d\'activation') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-1">
                                <button type="submit" class="btn btn-primary btn-raised btn-block btn-flat" style="border-radius: 5px;">
                                    {{ __('Valider') }}
                                </button>
                            </div>
                        </div>
