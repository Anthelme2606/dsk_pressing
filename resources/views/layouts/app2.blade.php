...
<head>
  ...
  <title>{{config('app2.name', 'PRESSING')}} | Client area</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{route('clientarea')}}" class="logo" style="background-color: rgb(58, 85, 77);">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">É<b>P</b></span>
      <!-- logo for regular state and mobile devices -->
      {{-- <img src="website/images/lg2.jpeg" style="background-color: rgb(60, 86, 78); height:75%; width:65%;" alt=""> --}}
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              @if(Auth::guard('client')->user()->picture == '')
                <img src="{{asset('public/avatar.jpeg')}}" class="user-image" alt="User Image">
              @else
                <img src="{{ asset('public/storage/profile_images/'.Auth::guard('client')->user()->picture) }}" class="user-image" alt="User Image">
              @endif
              <span class="hidden-xs">{{ Auth::guard('client')->user()->fullname }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                @else
                  <img src="{{ asset('storage/profile_images/'.Auth::guard('client')->user()->picture) }}" class="img-circle" alt="User Image">
                @endif
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ route('profil-client') }}" class="btn btn-default btn-flat">Profil</a>
                </div>
                <div class="pull-right">
                  <a href="{{ route('client.logout') }}" class="btn btn-default btn-flat" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Quitter</a>

                  <form id="logout-form" action="{{ route('client.logout') }}" method="POST" style="display: none;">@csrf
                    </form>
                </div>
              </li>
            </ul>
      ...
      <div class="user-panel">
        <div class="pull-left image">
          @if(Auth::guard('client')->user()->picture == '')
            <img src="{{asset('public/avatar.jpeg')}}" class="img-circle" alt="User Image">
          @else
            <img src="{{ url('public/storage/profile_images/'.Auth::guard('client')->user()->picture) }}" class="img-circle" alt="User Image">
          @endif
        </div>
        <div class="pull-left info">
          <p style="text-transform: capitalize;" class="col-md-offset-1">{{ Auth::guard('client')->user()->fullname }}</p>
