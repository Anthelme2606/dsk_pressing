        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tfoot>
                        <tr>
                            <td style="font-size: 24px; font-weight: bold; color: black;">Total des entrées : <span style="color: green; font-weight: bold; font-size: 18px;">{{ $in_price }}</span></td>
                            <td style="font-size: 24px; font-weight: bold; color: black;">Total des sorties : <span style="color: red; font-weight: bold; font-size: 18px;">{{ $out_price }}</span></td>
                        </tr>
                    </tfoot>
