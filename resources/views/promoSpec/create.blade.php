...
@section('title', '| Ajouter Promo Spéciale')
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        <i class='fa fa-plus-square'></i> Ajouter Promo Spéciale
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active"><i class='fa fa-plus-square'></i> Ajouter Promo Spéciale</li>
      </ol>
    </section>
            ...
            <div class='col-lg-6 col-lg-offset-2'>
                  <div class="box box-primary">
                      <div class="box-header with-border">
                        <h3 class="box-title"><i class='fa fa-plus-square'></i> Ajouter Promo Spéciale</h3>
                      </div>
                      <!-- /.box-header -->
                      <!-- form start -->
                      <form action="{{ route('promospec.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <input type="number" class="form-control" name="nbr_client" required/>
                                    </div>
                                </div>
