                ...
                <div class="box box-solid">
                    ...
                    <!-- /.box-header -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                        <a href="{{ route('classeurs.edit', $user->id) }}" class="btn btn-xs btn-info pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i> Editer</a>
                        ...
                        <div class="box-footer">
                          <a href="{{ route('classeurs.create') }}" class="btn bg-olive">Ajouter classeur</a>
                        </div>
                </div>
            </div>
        </div>
...
function deleteData(id)
     {
         var id = id;
         var url = '{{ route("classeurs.destroy", ":id") }}';
