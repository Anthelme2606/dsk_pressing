...
<html class="no-js" lang="en">
  <head>
	...
	Favicons
	=============================================== -->
	<link rel="shortcut icon" href="{{asset('public/website/images/lgElegance3.jpg') }}">
	<link rel="apple-touch-icon" href="{{asset('public/website/images/apple-touch-icon.png') }}">
	<link rel="apple-touch-icon" sizes="72x72" href="{{asset('public/website/images/apple-touch-icon-72x72.png') }}">
	<link rel="apple-touch-icon" sizes="114x114" href="{{asset('public/website/images/apple-touch-icon-114x114.png') }}">

	<!-- ==============================================
	CSS
	=============================================== -->
	<link rel="stylesheet" type="text/css" href="{{asset('public/website/css/bootstrap.css') }}" />
    ...
    <script type="text/javascript" src="{{asset('public/website/js/modernizr.min.js')}}"></script>
...
<body>
	...
	<div class="navbar navbar-main navbar-fixed-top">
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{{asset('#')}}"><span style="font-family:monospace; font-style:italic; font-size: 20px;"><img src="{{asset('public/website/images/z.png')}}" style="height: 65px; width:150px;" alt="" /></a>

			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
					  <a href="{{asset('#')}}" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ACCUEIL <span class="cart"></span></a>
					...
					<li><a href="{{ route('client.login') }}">ESPACE CLIENT</a></li>
			...
			<div class="caption">
				...
				<br><p class="yess" style="font-style: italic; font-size: 17px;">Vous souhaitez retrouver l'éclat de vos vêtements, avoir le "bling bling", vous garantir une belle prestance et le tout en un temps record, faites donc appel à
					<br><br><span style="font-size: 18px; font-family:Brush Script MT, Brush Script Std, cursive; font-size: 40px;"><em><i style="color: rgb(211, 211, 134);"> Elégance Pressing, Textile expert</i></em></span>
						{{-- <button type="submit" class="btn btn-default" style="background-color: red;">ENVOYER</button> --}}
					<!-- rgb(241, 183, 23); -->
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-5 col-md-offset-0">
					<div class="services-item left">
						<div class="icon">
							<img src="{{asset('website/images/lavage.jpg')}}" style="width: 105%;" alt="" class="img-circle" />
						</div>
						<div class="ket">
							<h4>LAVAGE</h4>
					...
					<div class="services-item left">
						<div class="icon">
							<img src="{{asset('website/images/pexels-pixabay-325876.jpg')}}" style="width: 105%;" alt="" class="img-circle" />
						</div>
						<div class="ket">
							<h4>RETOUCHERIE</h4>
				...
				<div class="col-sm-6 col-md-5 col-md-offset-2">
					<div class="services-item right">
						<div class="icon">
							<img src="{{asset('website/images/3.jpg')}}" style="width: 105%;" alt="" class="img-circle" />
						</div>
						<div class="ket">
							<h4>REPASSAGE</h4>
					...
					<div class="services-item right">
						<div class="icon">
							<img src="{{asset('website/images/OIP (1).jpg')}}" style="width: 105%;" alt="" class="img-circle" />
						</div>
						<div class="ket">
							<h4>EXPRESS</h4>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-lg-offset-1">
						<div class="footer-item">
							<div class="footer-logo">
								<img src="{{asset('website/images/elegance.jpeg')}}" style="height:60%; width:100%;" alt="" />
							</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-lg-offset-1">
						<div class="footer-item">
							...
							<div class="footer-blog-item">
								<div class="footer-blog-lead">
									<a href="{{asset('#services')}}" title="">Services</a>
								</div>
								<!-- <div class="footer-blog-date">
									May 29, 2015
								</div> -->
							...
							<div class="footer-blog-item">
								<div class="footer-blog-lead">
									<a href="{{ route('client.login') }}" title="">Espace client</a>
								</div>
								<!-- <div class="footer-blog-date">
									May 29, 2015
								</div> -->
	...
	<script type="text/javascript" src="{{asset('public/website/js/jquery.min.js')}}"></script>
	<script type='text/javascript' src='https://maps.google.com/maps/api/js?sensor=false&#038;ver=4.1.5'></script>
	<script type='text/javascript' src="{{asset('public/website/js/jqBootstrapValidation.js')}}"></script>
	<script type="text/javascript" src="{{asset('public/website/js/bootstrap.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('public/website/js/bootstrap-hover-dropdown.min.js')}}"></script>

	<script type="text/javascript" src="{{asset('public/website/js/script.js')}}"></script>
