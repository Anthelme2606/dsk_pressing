...
<div class="row">
    ...
    <div class='col-md-8 col-md-offset-2'>
        <div class="box box-primary">
            ...
            <form action="{{ route('laveurs.update', $user->id) }}" class="form-horizontal form-box remove-margin" method="POST" enctype="multipart/form-data">
                @method("PATCH")
                @csrf
        {{-- {{ Form::model($user, array('route' => array('laveurs.update', $user->id) , 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}Form model binding to automatically populate our fields with user data --}}
