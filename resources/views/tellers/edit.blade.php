    ...
    <div class='col-md-8 col-md-offset-2'>
        <div class="box box-primary">
            <div class="box-header with-border">
              <h4 class="box-tite"><b> Edition du caissier:</b> <em style="color:rgb(5, 146, 104)">{{$user->fullname}}</em></h4>
            </div>

            <form action="{{ route('tellers.update', $user->id) }}" class="form-horizontal form-box remove-margin" method="POST" enctype="multipart/form-data">
                @method("PATCH")
                @csrf
        {{-- {{ Form::model($user, array('route' => array('tellers.update', $user->id) , 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}Form model binding to automatically populate our fields with user data --}}
