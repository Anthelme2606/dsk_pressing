...
@section('content')
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('superadmin.users.edit', $user->id) }}" class="btn btn-xs btn-info pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i> Editer</a>
    ...
    <script>
        ...
        {
            var id = id;
            var url = '{{ route("superadmin.users.delete", ":id") }}';
