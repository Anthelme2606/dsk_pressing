    ...
    <div class="col-md-12">
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <a href="{{ route('superadmin.agences.create') }}" class="btn bg-olive pull-right"><i class='fa fa-plus-square'></i>  Ajouter Agence</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $agence->pressing()->name }}
                            </td>
                            <td>{{ $agence->created_at->format('F d, Y h:ia') }}</td>
                            <td>
                            <a href="{{ route('superadmin.agences.edit', $agence->id) }}" class="btn btn-info btn-xs" style="margin-right: 3px;"><i class="fa fa-edit"></i> Editer</a>
            ...
            <div class="box-footer clearfix">
              <a href="{{ route('superadmin.agences.create') }}" class="btn bg-olive"><i class='fa fa-plus-square'></i>  Ajouter Agence</a>
            </div>
        </div>
    </div>
</div>
...
function deleteData(id)
     {
         var id = id;
         var url = '{{ route("superadmin.agences.delete", ":id") }}';
