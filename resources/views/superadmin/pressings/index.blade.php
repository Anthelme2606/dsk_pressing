    ...
    <div class="col-md-12">
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <a href="{{ route('superadmin.pressings.create') }}" class="btn bg-olive pull-right"><i class='fa fa-plus-square'></i>  Ajouter Pressing</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="{{ route('superadmin.pressings.edit', $pressing->id) }}" class="btn btn-info btn-xs" style="margin-right: 3px;"><i class="fa fa-edit"></i> Editer</a>
            ...
            <div class="box-footer clearfix">
              <a href="{{ route('superadmin.pressings.create') }}" class="btn bg-olive"><i class='fa fa-plus-square'></i>  Ajouter Pressing</a>
            </div>
        </div>
    </div>
</div>
